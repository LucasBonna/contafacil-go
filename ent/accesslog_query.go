...
func (alq *AccessLogQuery) FirstID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (alq *AccessLogQuery) FirstIDX(ctx context.Context) uuid.UUID {
...
func (alq *AccessLogQuery) OnlyID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (alq *AccessLogQuery) OnlyIDX(ctx context.Context) uuid.UUID {
...
func (alq *AccessLogQuery) IDs(ctx context.Context) (ids []uuid.UUID, err error) {
...
func (alq *AccessLogQuery) IDsX(ctx context.Context) []uuid.UUID {
	ids, err := alq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (alq *AccessLogQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(accesslog.Table, accesslog.Columns, sqlgraph.NewFieldSpec(accesslog.FieldID, field.TypeUUID))
	_spec.From = alq.sql
