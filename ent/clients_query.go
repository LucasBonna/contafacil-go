...
func (cq *ClientsQuery) QueryUsers() *UserQuery {
...
func (cq *ClientsQuery) FirstID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (cq *ClientsQuery) FirstIDX(ctx context.Context) uuid.UUID {
...
func (cq *ClientsQuery) OnlyID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (cq *ClientsQuery) OnlyIDX(ctx context.Context) uuid.UUID {
...
func (cq *ClientsQuery) IDs(ctx context.Context) (ids []uuid.UUID, err error) {
...
func (cq *ClientsQuery) IDsX(ctx context.Context) []uuid.UUID {
	ids, err := cq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (cq *ClientsQuery) WithUsers(opts ...func(*UserQuery)) *ClientsQuery {
	query := (&UserClient{config: cq.config}).Query()
...
func (cq *ClientsQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Clients, error) {
	...
	if query := cq.withUsers; query != nil {
		if err := cq.loadUsers(ctx, query, nodes,
			func(n *Clients) { n.Edges.Users = []*User{} },
			func(n *Clients, e *User) { n.Edges.Users = append(n.Edges.Users, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (cq *ClientsQuery) loadUsers(ctx context.Context, query *UserQuery, nodes []*Clients, init func(*Clients), assign func(*Clients, *User)) error {
	...
	query.Where(predicate.User(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(clients.UsersColumn), fks...))
	}))
