...
func (uq *UserQuery) QueryClients() *ClientsQuery {
	query := (&ClientsClient{config: uq.config}).Query()
...
func (uq *UserQuery) Clone() *UserQuery {
	...
	return &UserQuery{
		...
		withClients: uq.withClients.Clone(),
...
func (uq *UserQuery) WithClients(opts ...func(*ClientsQuery)) *UserQuery {
	query := (&ClientsClient{config: uq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	uq.withClients = query
	return uq
}
...
func (uq *UserQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*User, error) {
	...
	if query := uq.withClients; query != nil {
		if err := uq.loadClients(ctx, query, nodes, nil,
			func(n *User, e *Clients) { n.Edges.Clients = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (uq *UserQuery) loadClients(ctx context.Context, query *ClientsQuery, nodes []*User, init func(*User), assign func(*User, *Clients)) error {
